...
$lang = array_merge($lang, array(
	'ACP_BBCODES_EXPLAIN'		=> 'Το BBCode είναι μια ειδική εφαρμογή του HTML που προσφέρει μεγαλύτερο έλεγχο στο που και στο πώς κάτι θα εμφανίζεται. Από αυτήν την σελίδα μπορείτε να προσθέσετε, να αφαιρέσετε ή να επεξεργαστείτε τα BBCodes.',
	...
	'BBCODE_DELETED'			=> 'BBCode διαγράφηκε επιτυχώς.',
	'BBCODE_NOT_EXIST'		=> 'Το BBCode που επιλέξατε δεν υπάρχει.',
	'BBCODE_HELPLINE'			=> 'Γραμμή βοήθειας',
	'BBCODE_HELPLINE_EXPLAIN'	=> 'Το κείμενο όπου θα εμφανιστεί στην γραμμή βοήθειας, εάν ο δείκτης του ποντικιού είναι πάνω στο BBCode.',
	'BBCODE_HELPLINE_TEXT'		=> 'Γραμμή βοήθειας κείμενο',
	'BBCODE_HELPLINE_TOO_LONG'	=> 'Η γραμμή βοήθειας που εισαγάγατε είναι πολύ μεγάλη',

	'BBCODE_INVALID_TAG_NAME'	=> 'Η BBCode ετικέτα όνομα που επιλέξατε ήδη υπάρχει.',
	'BBCODE_INVALID'			=> 'Ο BBCode σας είναι κατασκευασμένος σε μη έγκυρη μορφή.',
	'BBCODE_OPEN_ENDED_TAG'	=> 'Το προσαρμοσμένο BBCode πρέπει να περιέχει μια ανοιχτή και μια κλειστή ετικέτα.',
	'BBCODE_TAG'				=> 'Ετικέτα',
	...
	'tokens'	=>	array(
		'TEXT'		=> 'Οποιοδήποτε κείμενο, περιλαμβάνοντας και ξένους χαρακτήρες, αριθμούς, κλπ… Δεν πρέπει να χρησιμοποιείτε αυτό το σύμβολο μέσα σε ετικέτες HTML. Ανταυτού δοκιμάστε την χρήση των IDENTIFIER, INTTEXT ή SIMPLETEXT.',
		...
		'INTTEXT'		=> 'Χαρακτήρες Unicode, αριθμοί, κενά, κόμματα, τελείες, αρνητικά πρόσημα, θετικά πρόσημα, παύλες, κάτω παύλες και κενά διαστήματα.',
		'IDENTIFIER'	=> 'Χαρακτήρες του λατινικού αλφαβήτου (A-Z), αριθμοί, παύλες και   χαρακτήρες υπογράμμισης',
		'NUMBER'		=> 'Οποιαδήποτε σειρά αριθμών',
		'EMAIL'			=> 'Μια έγκυρη ηλεκτρονική διεύθυνση αλληλογραφίας',
		...
		'RELATIVE_URL'	=> 'Μια σχετική διεύθυνση URL. Μπορείτε να χρησιμοποιήσετε αυτό για να ταιριάξετε μέρος ενός URL, αλλά να είστε προσεκτικοί: μια πλήρη διεύθυνση URL είναι μία έγκυρη σχετική διεύθυνση URL. Όταν θέλετε να χρησιμοποιείσετε τις σχετικές διευθύνσεις του phpbb σας, χρησιμοποιήστε το κουπόνι LOCAL_URL.',
...
$lang = array_merge($lang, array(
	...
	'EMOTION'					=> 'Συναίσθημα',
	'EXPORT_ICONS'			=> 'Εξαγωγή και μεταφόρτωση πακέτου συμβόλων icons.pak',
	...
	'EXPORT_SMILIES_EXPLAIN'	=> '%sΜε αυτόν τον σύνδεσμο μπορείτε να γράψετε τις ρυθμίσεις των εγκατεστημένων smilies σε ένα αρχείο <samp>smilies.pak</samp> που μόλις μεταφορτωθεί μπορεί να χρησιμοποιηθεί για την δημιουργία ενός <samp>.zip</samp> ή <samp>.tgz</samp> αρχείου που περιέχει όλα τα σύμβολα συν το αρχείο ρυθμίσεων <samp>smilies.pak</samp>%s.',

	'FIRST'					=> 'Πρώτο',

	'ICONS_ADD'				=> 'Προσθέστε νέο εικονίδιο θέματος',
	'ICONS_ADDED'			=> array(
		0	=> 'Δεν προστέθηκαν εικονίδια.',
		1	=> 'Το εικονίδιο προστέθηκε με επιτυχία.',
		2	=> 'Τα εικονίδια προστέθηκαν με επιτυχία.',
	),
	'ICONS_CONFIG'			=> 'Διαμόρφωση εικονιδίου',
	'ICONS_DELETED'			=> 'Το εικονίδιο αφαιρέθηκε με επιτυχία.',
	'ICONS_EDIT'			=> 'Επεξεργασία εικονιδίου',
	'ICONS_EDITED'			=> array(
		0	=> 'Κανένα εικονίδιο δεν ενημερώθηκε',
		1	=> 'Το εικονίδιο έχει ενημερωθεί με επιτυχία.',
		2	=> 'Τα εικονίδια έχουν ενημερωθεί με επιτυχία.',
	),
	'ICONS_HEIGHT'			=> 'Ύψος εικονιδίου',
	'ICONS_IMAGE'			=> 'Εικόνα σύμβολου,',
	'ICONS_IMPORTED'		=> 'Το πακέτο εικονιδίων έχει εγκατασταθεί επιτυχώς',
	'ICONS_IMPORT_SUCCESS'	=> 'Η εισαγωγή του πακέτο εικονιδίων έγινε με επιτυχία.',
	'ICONS_LOCATION'		=> 'Τοποθεσία εικονιδίων',
	'ICONS_NOT_DISPLAYED'	=> 'Τα ακόλουθα εικονίδια δεν θα εμφανίζονται στην σελίδα δημοσίευσης',
	'ICONS_ORDER'			=> 'Ταξινόμηση εικονιδίων,'
	'ICONS_URL'			=> 'Αρχείο εικόνιδίων',
	'ICONS_WIDTH'			=> 'Πλάτος εικόνιδίου',
	...
	'NO_ICONS_ADD'		=> 'Δεν υπάρχει κανένα διαθέσιμο εικονίδιο για προσθήκη.',
	'NO_ICONS_EDIT'		=> 'Δεν υπάρχει κανένα διαθέσιμο εικονίδιο για επεξεργασία.',
	'NO_ICONS_EXPORT'		=> 'Δεν έχετε κανένα εικονίδιο με τα οποία θα δημιουργήσετε ένα πακέτο.',
	'NO_ICONS_PAK'		=> 'Κανένα πακέτο εικονιδίων δεν βρέθηκε.',
	...
	'NO_SMILIES_PAK'		=> 'Δεν βρέθηκε κανένα πακέτο smilies.',
	...
	'SMILIES_ADDED'				=> array(
		0	=> 'Κανένα smiley δεν έχει προστεθεί',
		1	=> 'Το smiley προστέθηκε με επιτυχία',
		2	=> 'Τα smilies προστέθηκαν με επιτυχία.',
	),
	...
	'SMILIE_NO_CODE'			=> 'Το smiley “%s” έχει αγνοηθεί, επειδή κανένας κώδικας δεν προστέθηκε.',
	'SMILIE_NO_EMOTION'		=> 'Το smiley “%s” έχει αγνοηθεί, επειδή κανένα "συναίσθημα" δεν προστέθηκε.',
	'SMILIE_NO_FILE'			=> 'Το smiley “%s” έχει αγνοηθεί, επειδή το αρχείο λείπει.',
	'SMILIES_EDITED'			=> array(
		0	=> 'Κανένα smiley δεν ενημερώθηκε.',
		1	=> 'Το smiley ενημερώθηκε με επιτυχία.',
		2	=> 'Τα smilies ενημερώθηκαν με επιτυχία.',
	),
	...
	'TOO_MANY_SMILIES'			=> array(
		1	=> 'Έχετε περάσει το όριο του %d smiley',
		2	=> 'Έχετε περάσει το όριο των %d smilies',
	),
...
// Word censors
$lang = array_merge($lang, array(
	'ACP_WORDS_EXPLAIN'		=> 'Από αυτόν τον πίνακα ελέγχου μπορείτε να προσθέσετε, να επεξεργαστείτε και να αφαιρέσετε τις λέξεις που θα λογοκριθούν αυτόματα στις Δ. Συζητήσεις σας. Οι εγγραφές εξακολουθούν να επιτρέπονται όπου θα περιέχουν αυτές τις λέξεις. Μπορείτε να εισάγετε και χαρακτήρες μπαλαντέρ (*) στο πεδίο κειμένου. πχ., αν βάλετε *test* θα ταιριάζει το detestable, test* θα ταιριάζει το testing, *test θα τεριάζει το detest.',
...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'	=> 'Χρησιμοποιώντας αυτήν την φόρμα μπορείτε να προσθέσετε, να επεξεργαστείτε, να δείτε και να διαγράψετε τους βαθμούς. Μπορείτε επίσης να δημιουργήσετε τους ειδικούς βαθμούς που μπορούν να οριστούν σε ένα μέλος μέσω της διαχείριση δυνατότητας μελών.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'	=> 'Εδώ μπορείτε να ελέγξετε τα ονόματα μελών που δεν επιτρέπετε να χρησιμοποιηθούν. Τα απαγορευμένα ονόματα μελών μπορούν να περιέχουν έναν χαρακτήρα μπαλαντέρ *.',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'Εδώ μπορείτε να διαχειριστείτε τους λόγους που χρησιμοποιούνται στις αναφορές και τα μηνύματα απόρριψης των δημοσιεύσεων. Υπάρχει ένας τυποποιημένος λόγος (που μαρκάρεται με *), ο οποίος δεν μπορεί να διαγραφεί. Αυτός ο λόγος χρησιμοποιείται εάν κανένας άλλος λόγος δεν έχει οριστεί.',
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'Ο λόγος <strong>δεν</strong> έχει εντοπιστεί. Εάν επιθυμείτε να δείξετε την τοπική έκδοση, δείξτε το σωστό κλειδί από το σχετικό τμήμα των γλωσσικών αρχείων.',
	...
	'REASON_EDIT_EXPLAIN'		=> 'Εδώ μπορείτε να προσθέσετε ή να επεξεργαστείτε έναν λόγο. Εάν ο λόγος είναι μεταφρασμένος η εντοπισμένη έκδοση χρησιμοποιείται αντί της περιγραφής που εισάγεται εδώ.',
	...
	'USED_IN_REPORTS'		=> 'Χρησιμοποιήται στις αναφορές,
));
