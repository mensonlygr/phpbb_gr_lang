...
$lang = array_merge($lang, array(
	...
	'DELETE_POSTS_PERMANENTLY_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να <strong>οριστικά</strong> διαγράψετε αυτές τις δημοσιεύσεις;',
	'DELETE_REASON'					=> 'Ο λόγος για διαγραφής',
	'DELETE_REASON_EXPLAIN'				=> 'Ο συγκεκριμένη λόγος της διαγραφής θα είναι ορατός στους συντονιστές.',
	'DELETE_POST_WARN'				=> 'Delete this post',
	'DELETE_TOPIC_CONFIRM'				=> 'Είστε σίγουρος ότι θέλετε να διαγράψετε αυτό το θέμα;',
	'DELETE_TOPIC_PERMANENTLY'			=> 'Οριστική διαγραφή αυτού του θέματος, ώστε να μην μπορεί να ανακτηθεί',
	'DELETE_TOPIC_PERMANENTLY_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να <strong>οριστικά</strong> διαγράψετε αυτό topic?',
	'DELETE_TOPICS_CONFIRM'				=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτά τα θέματα;',
	'DELETE_TOPICS_PERMANENTLY_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να <strong>οριστικά</strong> διαγράψετε αυτά να',
