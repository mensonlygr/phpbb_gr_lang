...
$lang = array_merge($lang, array(
	...
	'ALLOW_IN_PM'					=> 'Επιτρεπτό σε Προσωπικό Μήνυμα',
	...
	'ATTACH_MAX_FILESIZE_EXPLAIN'			=> 'Μέγιστο Μέγεθος Κάθε Αρχείου, βάζοντας 0 δεν έχουμε όριο, το όριο αυτό περιορίζεται μόνο από τις ρυθμίσεις της PHP που έχετε.',
	'ATTACH_MAX_PM_FILESIZE'			=> 'Μέγιστο Μέγεθος αρχείου ανά Προσωπικό Μήνυμα',
	'ATTACH_MAX_PM_FILESIZE_EXPLAIN'		=> 'Μέγιστο μέγεθος των συνημμένων αρχείων στα προσωπικά μηνύματα, προσθέστε 0 για χωρίς όριο.',
	...
	'CHECK_CONTENT_EXPLAIN'		=> 'Ορισμένοι πλοηγοί μπορεί να εξαπατηθούν για να υποθέσουν ένα ανακριβές είδος κωδικοποίησης για τα φορτωμένα αρχεία. Αυτή η επιλογή εξασφαλίζει ότι τέτοια αρχεία που πιθανών να το προκαλέσουν να απορριφθούν.',
	...
	'DOWNLOAD_ADD_IPS_EXPLAIN'		=> 'Για να προσθέσετε διαφορετικά IPs ή κεντρικούς υπολογιστές πληκτρολογήστε το καθένα σε διαφορετική γραμμή. Για εύρος διευθύνσεων IPs χωρίστε τη πρώτη και την τελευταία με μείον (-), για χαρακτήρα μπαλαντέρ βάλτε “*”.',
	...
	'FILES_GONE'			=> 'Κάποια από τα συνημμένα αρχεία που επιλέξατε για διαγραφή δεν υπάρχουν πια. Μπορεί να έχουν ήδη διαγραφεί. Τα συνημμένα αρχεία που υπήρχαν διαγράφηκαν.',
	'FILES_STATS_WRONG'		=> 'Τα στατιστικά των αρχείων είναι ανακριβή και χρειάζονται επανασυγχρονισμό. Οι πραγματικές τιμές είναι: αρυθμός συνημμένων = %1$d, συνολικό μέγεθος συνημμένων = %2$s.<br />Πατήστε %3$εδώ%4$s για να τα επανα συγχρονίσετε.',
	...
	'NO_ATTACHMENTS'		=> 'Δεν βρέθηκαν συνημμένα για αυτήν την περίοδο.',
	'NO_EXT_GROUP'			=> 'Καμία',
	...
	'NO_THUMBNAIL_SUPPORT'		=> 'Η υποστήριξη Μικρογραφίας έχει απενεργοποιηθεί. Για περαιτέρω χρήση θα πρέπει να υπάρχει η Επέκταση GD ή να εγκατασταθεί το Ιmagemagick. Κανένα από τα δύο δεν βρέθηκε.',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Είσαι σύγουρος πως θέλεις να κάνεις ανά συγχρονισμό των στατιστικών των αρχείων;',
	...
	'SECURE_DOWNLOAD_NOTICE'		=> 'Η ασφαλή μεταφόρτωση δεν είναι ενεργοποιημένη. Οι παρακάτω ρυθμίσεις θα μπουν σε λειτουργεία αφού ενεργοποιήσετε την ασφαλή μεταφόρτωση.',
	'SECURE_DOWNLOAD_UPDATE_SUCCESS'	=> 'Η λίστα IP έχει ενημερωθεί.',
