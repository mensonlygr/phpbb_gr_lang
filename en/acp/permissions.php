...
$lang = array_merge($lang, array(
	...
	'ACP_FORUM_PERMISSIONS_COPY_EXPLAIN'		=> 'Εδώ μπορείτε να αντιγράψετε τα δικαιώματα από ένα φόρουμ σε ένα ή περισσότερα άλλα φόρουμ.',
	...
	'ADVANCED_PERMISSIONS'		=> 'Προηγμένες επιλογές',
	...
	'APPLY_PERMISSIONS'			=> 'Εφαρμογή δικαιωμάτων',
	'APPLY_PERMISSIONS_EXPLAIN'	=> 'Τα δικαιώματα πρόσβασης και ο ρόλος που καθορίζονται για αυτό το στοιχείο θα εφαρμοστούν μόνο σε αυτό το στοιχείο και όλα τα επιλεγμένα στοιχεία.',
	...
	'ROLE_USER_FULL'			=> 'Όλες οι δυνατότητες',
	'ROLE_USER_LIMITED'			=> 'Οριακές δυνατότητες',
	'ROLE_USER_NOAVATAR'		=> 'Κανένα Είδωλο',
	'ROLE_USER_NOPM'			=> 'Χωρίς Προσωπικά Μηνύματα',
	'ROLE_USER_STANDARD'		=> 'Standard Features',
	'ROLE_USER_NEW_MEMBER'		=> 'Τυπικές δυνατότητες',
	...
	'ROLE_DESCRIPTION_ADMIN_STANDARD'		=> 'Έχει πρόσβαση στις περισσότερες διαχειριστικές  λειτουργίες αλλά δεν επιτρέπεται να χρησιμοποιήσει εργαλεία σχετικά με το σύστημα .',
	...
	'ROLE_DESCRIPTION_FORUM_FULL'			=> 'Μπορεί να χρησιμοποιήσει όλες τις δυνατότητες της Δ. Συζήτησης, συμπεριλαμβανομένων της δημοσίευσης ανακοινώσεων και σημειώσεων. Μπορεί επίσης να αγνοήσει το όριο αναμονής.<br />Δεν συνιστάτε για κανονικά μέλη.',
	'ROLE_DESCRIPTION_FORUM_LIMITED'		=> 'Μπορεί να χρησιμοποιήσει μερικά δυνατότητες της Δ. Συζήτησης, αλλά δεν μπορεί να επισυνάψει αρχεία ή να χρησιμοποιήσει τα σύμβολα δημοσίευσης.',
	...
	'ROLE_DESCRIPTION_FORUM_STANDARD'		=> 'Μπορεί να χρησιμοποιήσει τις περισσότερες δυνατοτητες της Δ. Συζήτησης συμπεριλαμβανομένων των συνημμένων και της διαγραφής των θεμάτων των, αλλά δεν μπορεί να κλειδώσει θέματα του και να δημιουργήσει δημοψηφίσματα.',
	'ROLE_DESCRIPTION_FORUM_NEW_MEMBER'		=> 'Ένας ρόλος για τα μέλη της πρόσφατα εγγραμμένης ομάδας μελών περιέχει: <samp>ΠΟΤΕ</samp> τις άδειες να κλειδωθούν τα χαρακτηριστικά γνωρίσματα για τα νέα μέλη.',
	'ROLE_DESCRIPTION_MOD_FULL'				=> 'Μπορεί να χρησιμοποιήσει όλες τις συντονιστικές δυνατότητες, συμπεριλαμβανομένης της αποβολής μέλους.',
	...
	'ROLE_DESCRIPTION_MOD_SIMPLE'			=> 'Μπορεί να χρησιμοποιήσει τις βασικές δυνατότητες θέματος. Δεν μπορεί να στείλει προειδοποιήσεις ή να χρησιμοποιήσει την σειρά αναμονής.',
	...
	'ROLE_DESCRIPTION_USER_FULL'			=> 'Μπορεί να χρησιμοποιήσει όλες τις δυνατότητεςς της Δ. Συζήτησης για τα μέλη, συμπεριλαμβανομένης της αλλαγής του ονόματος μέλους ή της αγνόησης του ορίου αναμονής.<br />Δεν Συνιστάτε.',
	'ROLE_DESCRIPTION_USER_LIMITED'			=> 'Μπορεί να έχει πρόσβαση σε μερικές από τις δυνατότητες μελών. Τα συνημμένα, οι διευθύνσεις ηλεκτρ. αλληλογραφίας και τα στιγμιαία μηνύματα δεν επιτρέπονται.',
	...
	'ROLE_DESCRIPTION_USER_STANDARD'		=> 'Μπορεί να έχει πρόσβαση στις περισσότερες όμως όχι σε όλες τις δυνατότητες μέλους. Δεν μπορεί να αλλάξει το όνομα μελών ή να αγνοήσει το όριο αναμονής, για παράδειγμα.',
	'ROLE_DESCRIPTION_USER_NEW_MEMBER'		=> 'Ένας ρόλος για τα μέλη της πρόσφατα εγγραμμένης ομάδας μελών δεν περιέχει <samp>ΠΟΤΕ</samp> τις άδειες να κλειδωθούν τα χαρακτηριστικά γνωρίσματα για τα νέα μέλη.',

	'ROLE_DESCRIPTION_EXPLAIN'		=> 'Εδώ μπορείτε να καταχωρίσετε μια σύντομη εξήγηση του τι κάνει αυτός ο ρόλος ή για ποιο σκοπό έχει γίνει. Το κείμενο που εισάγετε εδώ θα εμφανιστεί μέσα στις οθόνες αδειών επίσης.',
	...
	'TRACE_DEFAULT'					=> 'Εξ ορισμού κάθε άδεια είναι <samp>ΟΧΙ</samp> (unset). Έτσι η άδεια μπορεί να αντικατασταθεί από άλλες ρυθμίσεις.',
	...
	'WRONG_PERMISSION_TYPE'				=> 'Επιλέγθηκε λάθος τύπο πρόσβασης..',
	'WRONG_PERMISSION_SETTING_FORMAT'	=> 'Οι ρυθμίσεις δικαιωμάτων είναι σε λανθασμένη μορφή, το  phpBB δεν είναι ικανό να τις επεξεργαστεί σωστά.',
));
